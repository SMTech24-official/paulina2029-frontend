...
export const testimonials = Array(8).fill({
  ...
  text: "We were extremely pleased with the roofing replacement Infinity Exteriors did for us! They got our job ready and on the schedule quickly. Our project manager kept us informed throu",
  author: "David London NW3",
  date: "September 12, 2022",
  avatar: avatarImg,
});

// You can also add more realistic data like this:
